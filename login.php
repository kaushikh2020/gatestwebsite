...
function logIn() {
document.getElementById("loginStatus").innerHTML = "Welcome to Geometrixx! You're logged in!";
}
</script>
...
<!-- ************************************************************ ANALYTICS TAGS END  ************************************* -->
    ...
    <div id="superwrap">
        <div id="wrapper">
            <!--start logo and head-->
            <div class="head_logo">
                <a href="index.php" onmouseover="document.jj.src='http://ats-sb.adobe.com/jjsite/include/images/jj_logo_green.png'" onmouseout="document.jj.src='http://ats-sb.adobe.com/jjsite/include/images/jj_logo_black.png'"><img src="http://ats-sb.adobe.com/jjsite/include/images/jj_logo_black.png" border="0" name="jj" />
                </a>
                <br />
            </div>
            <!--start search box-->
            ...
            <div style="margin:6px 0px 0px -3px;">
                <table border="0">
                    <td>
                        <!---Form Start--->
                        <td>
                            <table><span class="description">Log into Geometrixx<br/><br/></span>
                                <div class="form">
        ...
        <!--start footer--><span class="footer">Copyright &#169 1996-2018 Adobe Digital Learning Services. All Rights Reserved.<span style="float: right"> <a href="sitemap.php">Site Map</a></span></span>
        <!--end footer-->
    </div>
