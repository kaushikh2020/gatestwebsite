...
<!-- ************************************************************ ANALYTICS TAGS END ************************************* -->
    ...
    <script>
        ...
        digitalData = {
            page: {
                pageName: "Fine Apparel Page",
                siteSection: "Women's Section",
                siteSubsection: "Women:Fine Apparel",
                server: "USA Server"
            },
        };
    </script>
    ...
    <title>Geometrixx|Women|Fine Apparel</title>
...
<br />
            ...
            <!--start page content-->
            <br />
            <span class="category">Women's Fine Apparel</span>
            <table border="0">
                <tr>
