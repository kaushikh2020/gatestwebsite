...
<!-- ************************************************************ ANALYTICS TAGS END ************************************* -->
    ...
    <title>Geometrixx|Checkout|Shipping Step 1</title>
                        ...
                        <div class="form">
                            <form action="payment2.php">
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="firstname" class="textinput" value="Art">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="lastname" class="textinput" value="Vandelay">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="address1" class="textinput" value="Adobe Systems">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="address2" class="textinput" value="3900 Adobe Way">
                                        <div style="font: 9px Verdana">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="city" class="textinput" value="Lehi">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="state" class="textinput" value="Utah">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="postalcode" class="textinput" value="84043">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="text" name="phone2" class="textinput" size="13" value="345-0000">
                                    </td>
                                </tr>
