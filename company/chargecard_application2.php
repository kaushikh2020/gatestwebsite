...
<!--    *********************************** ANALYTICS SCRIPTS END ***************************************** -->
    ...
    <title>Geometrixx|Company|Geo Charge Card Step 2</title>
            ...
            <table border="0" height="250" width="750" style="margin-left:50px;margin-top:30px;">
                ...
                <td>
                    <table>
                        ...
                        <span class="description">Geometrixx Charge Card Application 
<br/>Step 2</span>
                        ...
                        <div class="form">
                            <form action="http://training.adobe.com">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="firstname" class="textinput" value="Bento">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="lastname" class="textinput" value="Gon&#231;alves">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="email" class="textinput" value="ben.g@adobe.com">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="address" class="textinput" value="Rua Sinimbu, 2091">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="city" class="textinput" value="Caxias do Sul">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="state" class="textinput" value="Rio Grande do Sul">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="zip" class="textinput" value="95020-520">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="phone2" class="textinput" size="20" value="+55(54)2006-1890">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                       ...
                                       <a href="http://ats-sb.adobe.com/jjsite/include/include/charge_card_site.html" class="button2" onClick="_sattelite.track('ccapp')">Proceed to Apply</a>
                                    </td>
                                </tr>
