...
<!--    *********************************** ANALYTICS SCRIPTS END ***************************************** -->
    ...
    <title>Geometrixx|Company</title>
                        ...
                        <td valign="top">
                            <div style="width:195px;margin-right:5px;">
                                <a href="chargecard_application1.php">
                                    <img src="http://ats-sb.adobe.com/jjsite/include/images/chargecard_greenfield.png" class="photo" width="190" border="0" />
                                </a>
                                <br />
                                <div class="category">
                                    <a href="chargecard_application1.php">Geometrixx Charge Card</a>
                                </div>
                            </div>
                        </td>
                        <td valign="top">
                            <div style="width:195px;margin-right:5px;">
                                ...
                                <br />
                                <div class="category"><a href="travel1.php">Geometrixx Travel</a>
                                </div>
                            </div>
                        </td>
                        <td valign="top">
                            <div style="width:195px;margin-right:5px;">
                                ...
                                <br />
                                <div class="category"><a href="newsletter1.php">Geometrixx Newsletters</a>
                                </div>
                            </div>
                        </td>
                        <td valign="top">
