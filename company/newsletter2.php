    ...
    <script>
        ...
        digitalData = {
            page: {
                ...
                server: "USA Server",
				newsletter: "Geo Living|Geo Foreign Policy|Geo Special Offers|Random Spam"
            },
        };
    </script>

    <title>Geometrixx|Company|Newsletter Subscription Completion</title>
...
<body>
    ...
    <!--Adobe Analytics marketing reports & analytics -->
...
Thanks for signing up for the Geometrixx Newsletter!
</span>
                        <br/>
                        <br/>
